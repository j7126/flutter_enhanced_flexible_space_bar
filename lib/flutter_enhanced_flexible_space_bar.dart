// Copyright 2024 Jefferey Neuffer. All rights reserved.
// Copyright 2014 The Flutter Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

library flutter_enhanced_flexible_space_bar;
...
/// [EnhancedFlexibleSpaceBar.createSettings], to convey sizing information down to the
/// [EnhancedFlexibleSpaceBar].
///
/// {@tool dartpad}
/// This sample application demonstrates the different features of the
/// [EnhancedFlexibleSpaceBar] when used in a [SliverAppBar]. This app bar is configured
/// to stretch into the overscroll space, and uses the
/// [EnhancedFlexibleSpaceBar.stretchModes] to apply `fadeTitle`, `blurBackground` and
...
class EnhancedFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const EnhancedFlexibleSpaceBar({
    super.key,
    this.title,
  ...
  /// Shown behind the [title] when not expanded.
  ...
  /// to the [EnhancedFlexibleSpaceBar].
  ///
  ...
  /// [EnhancedFlexibleSpaceBar] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [EnhancedFlexibleSpaceBar] when fully expanded.
  /// `currentExtent` sets the scale of the [EnhancedFlexibleSpaceBar.expandedBackground] and
  /// [EnhancedFlexibleSpaceBar.title] widgets of [EnhancedFlexibleSpaceBar] upon
  /// initialization. `scrolledUnder` is true if the [EnhancedFlexibleSpaceBar]
  ...
  ///    used to specify these settings to a [EnhancedFlexibleSpaceBar].
  ...
  @override
  State<EnhancedFlexibleSpaceBar> createState() => _EnhancedFlexibleSpaceBarState();
}

class _EnhancedFlexibleSpaceBarState extends State<EnhancedFlexibleSpaceBar> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        // expanded background
        if (widget.expandedBackground != null) {
          ...
          children.add(Positioned(
            ...
            child: _FlexibleSpaceHeaderOpacity(
                ...
                opacity: opacity,
                child: widget.expandedBackground),
          ));
